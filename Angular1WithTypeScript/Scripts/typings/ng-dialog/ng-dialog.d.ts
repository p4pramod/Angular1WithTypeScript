...
declare namespace angular.dialog {
	...
	interface IDialogService {
		...
		openConfirm(options: IDialogOpenConfirmOptions): ng.IPromise<any>;
	...
	interface IDialogOpenResult {
		...
		closePromise: ng.IPromise<IDialogClosePromise>;
	}
	...
	interface IDialogProvider extends ng.IServiceProvider {
		/**
